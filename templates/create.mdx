...
```bash cURL
curl -X POST "https://cloud.weblix.co.il/templates/create" \
...
const response = await fetch('https://cloud.weblix.co.il/templates/create', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://cloud.weblix.co.il/templates/create',
...
```bash cURL
curl -X GET "https://cloud.weblix.co.il/templates?status=APPROVED&limit=50" \
  -H "Authorization: Bearer YOUR_TOKEN"
```

```javascript JavaScript
const response = await fetch('https://cloud.weblix.co.il/templates?status=APPROVED&limit=50', {
  headers: {
    'Authorization': 'Bearer YOUR_TOKEN'
  }
});
...
response = requests.get(
    'https://cloud.weblix.co.il/templates?status=APPROVED&limit=50',
    headers={'Authorization': 'Bearer YOUR_TOKEN'}
)
...
```bash cURL
curl -X GET "https://cloud.weblix.co.il/templates/template_abc123def456" \
  -H "Authorization: Bearer YOUR_TOKEN"
```

```javascript JavaScript
const response = await fetch('https://cloud.weblix.co.il/templates/template_abc123def456', {
  headers: {
    'Authorization': 'Bearer YOUR_TOKEN'
  }
});
...
```bash cURL
curl -X PUT "https://cloud.weblix.co.il/templates/template_abc123def456" \
  -H "Authorization: Bearer YOUR_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
    "components": [
...
```bash cURL
curl -X DELETE "https://cloud.weblix.co.il/templates/template_abc123def456" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
