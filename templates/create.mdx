...
<Frame caption="The four component types, and where each one lands on the customer's phone">
  <img src="/images/template-anatomy.webp" alt="A WhatsApp template message with its header, body, footer and buttons outlined and labelled with the matching component types" />
</Frame>
...
- [Monitor template performance](/analytics/overview) with analytics
