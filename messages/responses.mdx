...
<CardGroup cols={2}>
  <Card title="Retry Failed Messages" icon="rotate-right" href="/messages/retries">
    Turn the `failed` rows above into a safe bulk retry
  </Card>
  <Card title="Conversations" icon="comments" href="/chats/conversations">
    The same messages grouped into threads, with unread counts
  </Card>
</CardGroup>
