...
```bash cURL
curl -X GET "https://cloud.weblix.co.il/instances/me" \
  -H "Authorization: Bearer YOUR_TOKEN"
```

```javascript JavaScript
const response = await fetch('https://cloud.weblix.co.il/instances/me', {
  headers: {
...
response = requests.get(
    'https://cloud.weblix.co.il/instances/me',
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://cloud.weblix.co.il/instances/me',
...
```bash
curl -X GET "https://cloud.weblix.co.il/messages/responses?wa_message_id=wamid.HBgMTIzNDU2Nzg5MDEyMzQVAgARGBI5RkY2NzAyQUIyNEE4RkQ2AA==" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
```javascript
const SANDBOX_BASE_URL = 'https://cloud.weblix.co.il';
```
