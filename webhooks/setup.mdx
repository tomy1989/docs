...
```bash cURL
curl -X POST "https://cloud.weblix.co.il/webhooks/endpoints" \
...
const response = await fetch('https://cloud.weblix.co.il/webhooks/endpoints', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://cloud.weblix.co.il/webhooks/endpoints',
...
```bash cURL
curl -X POST "https://cloud.weblix.co.il/webhooks/test" \
  -H "Authorization: Bearer YOUR_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
...
const response = await fetch('https://cloud.weblix.co.il/webhooks/test', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer YOUR_TOKEN',
    'Content-Type': 'application/json'
...
```bash
curl -X GET "https://cloud.weblix.co.il/webhooks/endpoints" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
```bash
curl -X PUT "https://cloud.weblix.co.il/webhooks/endpoints/webhook_endpoint_123" \
  -H "Authorization: Bearer YOUR_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE "https://cloud.weblix.co.il/webhooks/endpoints/webhook_endpoint_123" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
```bash
curl -X GET "https://cloud.weblix.co.il/webhooks/logs?endpoint_id=webhook_endpoint_123&limit=50" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
