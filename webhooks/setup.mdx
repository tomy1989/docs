...
```bash cURL
curl -X POST "https://api.megasend.co/webhooks/endpoints" \
...
const response = await fetch('https://api.megasend.co/webhooks/endpoints', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://api.megasend.co/webhooks/endpoints',
...
```bash cURL
curl -X POST "https://api.megasend.co/webhooks/test" \
  -H "Authorization: Bearer YOUR_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
...
const response = await fetch('https://api.megasend.co/webhooks/test', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer YOUR_TOKEN',
    'Content-Type': 'application/json'
...
```bash
curl -X GET "https://api.megasend.co/webhooks/endpoints" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
```bash
curl -X PUT "https://api.megasend.co/webhooks/endpoints/webhook_endpoint_123" \
  -H "Authorization: Bearer YOUR_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE "https://api.megasend.co/webhooks/endpoints/webhook_endpoint_123" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
```bash
curl -X GET "https://api.megasend.co/webhooks/logs?endpoint_id=webhook_endpoint_123&limit=50" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
