...
```bash
# First page
curl "https://api.megasend.co/messages?limit=20" \
  -H "Authorization: Bearer YOUR_TOKEN"

# Next page
curl "https://api.megasend.co/messages?limit=20&cursor=eyJpZCI6Im1zZ18yIiwiZGlyZWN0aW9uIjoibmV4dCJ9" \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
```
https://api.megasend.co/v1/messages/send
```
